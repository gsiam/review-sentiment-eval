...
In the strong/strong configuration, both roles run `claude-sonnet-4-6`. Shared training data and RLHF signal imply shared blind spots — the judge may systematically overlook the same errors the summarizer commits. This is correlated bias and it would inflate apparent reliability.
